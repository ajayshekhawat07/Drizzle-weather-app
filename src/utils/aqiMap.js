...
export const getPm10Category = (concentration) => {
...
export const getPm2_5Category = (concentration) => {
...
export const getCOCategory = (concentration) => {
...
export const getNO2Category = (concentration) => {
...
export const getS02Category = (concentration) => {
...
export const get03Category = (concentration) => {
  if (concentration > 0 && concentration <= 55) {
    return { category: "Good", textColor: "text-green-500" };
